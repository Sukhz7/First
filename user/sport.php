...
<html>
	...
	<body>
		...
		<div class = "row">
			<?php
				while($sdetail = mysqli_fetch_array($rslt))
				{
			?>
			<div class = "col-md-6">
				<div class="card">
					<img src="../img/<?= $sdetail['sport_img']; ?>" alt="Avatar" style="width:100%">
					<hr>
					<div class="container">
						<center><h4><b><?= $sdetail['sport_name']; ?></b></h4></center>
						<hr>
						<p style = "font-size: 20px;"><?= $sdetail['sport_desc']; ?></p>  
					</div>
				</div>
				<hr>
			</div>
